package net.letsgta.server.api.oauth.dto.response;

import java.util.Map;
import lombok.Builder;
import net.letsgta.server.api.oauth.exception.OAuthException;
import net.letsgta.server.api.oauth.exception.OAuthExceptionResult;
